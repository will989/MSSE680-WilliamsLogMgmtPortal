...
CREATE DATABASE [andy680]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'andy680', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\andy680.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
